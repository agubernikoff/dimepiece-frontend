...
function FeaturedArticle() {
  ...
  useEffect(() => {
    client
      .fetch(
        `*[_type == "articles" && isFeatured == true][0]{_id,title,category,_createdAt,coverImage{asset->{url}}}`
      )
  ...
  if(featured)return (
    <div className="featured-story">
      <img className="featured-story-img" alt="***TO BE FIXED***" src={featured.coverImage.asset.url}/>
